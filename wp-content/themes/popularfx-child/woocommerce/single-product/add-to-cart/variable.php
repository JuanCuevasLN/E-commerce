	...
	<?php else : ?>
        <div class="variations" cellspacing="0" role="presentation">
            <?php foreach ( $attributes as $attribute_name => $options ) : ?>
                <div class="section">
                    <label class="selection-label" for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php echo wc_attribute_label( $attribute_name ); // WPCS: XSS ok. ?></label>
                    <div class="color-options value">
                        <?php
                            wc_custum_dropdown_variation_attribute_options(
                                array(
                                    'options'   => $options,
